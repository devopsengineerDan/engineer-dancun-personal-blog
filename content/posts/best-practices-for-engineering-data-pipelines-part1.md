...
tags = ["python"]
date = 2023-09-09T13:29:58+03:00
...
- [Reviewing the Business Problem](#reviewing-the-business-problem)
- [Reviewing the Technical Problem](#reviewing-the-technical-problem)
    - [Example Prediction Request JSON](#example-prediction-request-json)
    - [Example Prediction Response JSON](#example-prediction-response-json)
- [Solution Architecture](#solution-architecture)
- [Structuring the Pipeline Project](#structuring-the-pipeline-project)
- [Setting-Up the Local Dev Environment](#setting-up-the-local-dev-environment)
- [Setting-Up the Testing Framework](#setting-up-the-testing-framework)
    - [Using Tox for Test Automation](#using-tox-for-test-automation)
